...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tbf="http://www.altova.com/MapForce/UDF/tbf" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="tbf xs">
	...
	<xsl:template match="/">
		...
		<root>
			<xsl:attribute name="xsi:noNamespaceSchemaLocation" namespace="http://www.w3.org/2001/XMLSchema-instance">file:///E:/repos/GitHub/biotoolsShim/xml2genericxml/versions/biotools-3.0.0/biotools-3.0.0_framework.xsd</xsl:attribute>
			<list>
				<xsl:for-each select="tools/tool">
					...
					<list-item>
						...
						<xsl:for-each select="summary/biotoolsID">
							<xsl:variable name="var3_cur" select="."/>
							<biotoolsID>
								<xsl:value-of select="."/>
							</biotoolsID>
						</xsl:for-each>
						<xsl:for-each select="summary/biotoolsCURIE">
						...
						<toolType>
							<xsl:for-each select="labels/toolType">
						...
						<elixirPlatform>
							<xsl:for-each select="labels/elixirPlatform">
						...
						<elixirNode>
							<xsl:for-each select="labels/elixirNode">
